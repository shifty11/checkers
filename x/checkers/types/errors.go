...
var (
	...
	ErrThereIsNoWinner         = sdkerrors.Register(ModuleName, 1118, "there is no winner")
	ErrWinnerNotParsable       = sdkerrors.Register(ModuleName, 1119, "winner cannot be parsed: %s")
	ErrInvalidDateAdded        = sdkerrors.Register(ModuleName, 1120, "date added cannot be parsed: %s")
	ErrCannotAddToLeaderboard  = sdkerrors.Register(ModuleName, 1121, "cannot add to leaderboard")
)
